...
const FlashcardData = {
  mandarin: {
    newbie: [
      ...
      { front: 'yīdiǎn', back: 'a liltle/ a bit', audio: '一点' },
      ...
      { front: 'bìhǔ', back: 'liazrd', audio: '壁虎' },
    ...
    level1: {
      text: [
        ...
        { front: 'kuài', back: 'piece/informal for money', audio: '块' },
        ...
        { front: 'wàigōng', back: 'maternal grandfather', audio: '外公' },
        { front: 'nǎinai', back: 'grandmother', audio: '奶奶' },
      ...
      hanyupinyin: [
        ...
        { front: 'gāngbǐ', back: 'pen', audio: '钢笔' },
        { front: 'qiángbì', back: 'wall', audio: '墙壁' },
        { front: 'bōlí', back: 'glass', audio: '玻璃' },
        { front: 'bóbo', back: 'uncle', audio: '伯伯' },
        { front: 'bǒzi', back: 'lame person/cripple', audio: '跛子' },
        { front: 'bòjī', back: 'dustpan', audio: '簸箕' },
        { front: 'bō fàng', back: 'broadcast', audio: '播放' },
        { front: 'fàng', back: 'to put', audio: '放' },
        { front: 'bó chē', back: 'parking', audio: '泊车' },
        { front: 'bó', back: 'to park', audio: '泊' },
        { front: 'chē', back: 'vehicle/car', audio: '车' },
        { front: 'qìchē', back: 'car', audio: '汽车' },
        { front: 'bōcài', back: 'spinach', audio: '菠菜' },
        { front: 'bōluó', back: 'pineapple', audio: '菠萝' },
        { front: 'luóbo', back: 'carrot', audio: '萝卜' },
        { front: 'bǔ yú', back: 'fishing', audio: '捕鱼' },
        { front: 'yú', back: 'fish', audio: '鱼' },
        { front: 'pǎobù', back: 'running', audio: '跑步' },
        { front: 'pǎo', back: 'run', audio: '跑' },
        { front: 'bù', back: 'step', audio: '步' },
        { front: 'pā zài dìshàng', back: 'lie on the groud', audio: '趴在地上' },
        { front: 'pā', back: 'to lie', audio: '趴' },
        { front: 'dìshàng', back: 'on the ground', audio: '地上' },
        { front: 'dì', back: 'ground', audio: '地' },
        { front: 'shàng', back: 'on', audio: '上' },
        { front: 'pá', back: 'to climb', audio: '爬' },
        { front: 'pà', back: 'afraid', audio: '怕' },
        { front: 'páshǒu', back: 'pickpocket', audio: '扒手' },
        { front: 'píngguǒ', back: 'apple', audio: '苹果' },
        { front: 'yī pǐ mǎ', back: 'a horse', audio: '一匹马' },
        { front: 'pífū', back: 'skin', audio: '皮肤' },
        { front: 'piào', back: 'ticket', audio: '票' },
        { front: 'piàn', back: 'lie/cheat', audio: '骗' },
        { front: 'shānpō', back: 'hillside', audio: '山坡' },
        { front: 'shān', back: 'hill/mountain', audio: '山' },
        { front: 'wàipó', back: 'maternal grandmother', audio: '外婆' },
        { front: 'wài', back: 'out', audio: '外' },
        { front: 'pópo', back: 'grandmother', audio: '婆婆' },
        { front: 'pǒcè', back: 'unpredicatable', audio: '叵测' },
        { front: 'dǎpò', back: 'break', audio: '打破' },
        { front: 'pòhuài', back: 'destroy/damage', audio: '破坏' },
        { front: 'pū kè', back: 'poker', audio: '扑克' },
        { front: 'pú tao', back: 'grapes', audio: '葡萄' },
        { front: 'pùbù', back: 'waterfall', audio: '瀑布' },
        { front: 'gē pǔ', back: 'songsheet', audio: '歌谱' },
        { front: 'gōngpú', back: 'public servant', audio: '公仆' },
        { front: 'mā ma', back: 'mother', audio: '妈妈' },
        { front: 'mádài', back: 'sack', audio: '麻袋' },
        { front: 'mǎyǐ', back: 'ants', audio: '蚂蚁' },
        { front: 'mà jià', back: 'scoldings', audio: '骂架' },
        { front: 'hào mǎ', back: 'number', audio: '号码' },
        { front: 'mǎláixīyà', back: 'Malaysia', audio: '马来西亚' },
        { front: 'xiǎo māomī', back: 'kitten sound', audio: '小猫咪' },
        { front: 'mílù', back: 'lost', audio: '迷路' },
        { front: 'lù', back: 'road', audio: '路' },
        { front: 'báimǐ', back: 'white rice', audio: '白米' },
        { front: 'fēngmì', back: 'honey', audio: '蜂蜜' },
        { front: 'mìfēng', back: 'bee', audio: '蜜蜂' },
        { front: 'yībǎi mǐ', back: 'one hundred meter', audio: '一百米' },
        { front: 'mìmì', back: 'secret', audio: '秘密' },
        { front: 'mōtóu', back: 'touch head', audio: '摸头' },
        { front: 'mō', back: 'to touch', audio: '摸' },
        { front: 'mógū', back: 'mushroom', audio: '蘑菇' },
        { front: 'mǒ bù', back: 'cleaning rag', audio: '抹布' },
        { front: 'mǒ', back: 'to wipe', audio: '抹' },
        { front: 'mòzhī', back: 'ink', audio: '墨汁' },
        { front: 'mòyú', back: 'cuttlefish', audio: '墨鱼' },
        { front: 'zhōumò', back: 'weekend', audio: '周末' },
        { front: 'múyàng', back: 'appearance', audio: '模样' },
        { front: 'mǔqīn', back: 'mother (formal)', audio: '母亲' },
        { front: 'mǔzhǐ', back: 'thumb', audio: '拇指' },
        { front: 'mùbǎn', back: 'board', audio: '木板' },
        { front: 'mù', back: 'wood', audio: '木' },
        { front: 'mùbiāo', back: 'aims/Target/ Goal', audio: '目标' },
        { front: 'fāshāo', back: 'fever', audio: '发烧' },
        { front: 'fá zhàn', back: 'stand penalty', audio: '罚站' },
        { front: 'fá', back: 'to punish', audio: '罚' },
        { front: 'zhàn', back: 'stand/staion', audio: '站' },
        { front: 'fǎguān', back: 'judge', audio: '法官' },
        { front: 'fàlà', back: 'hairwax', audio: '发蜡' },
        { front: 'làzhú', back: 'candle/wax', audio: '蜡烛' },
        { front: 'tóufa', back: 'hair', audio: '头发' },
        { front: 'fā měng', back: 'dazed', audio: '发懵' },
        { front: 'fā mèng', back: 'dream', audio: '发梦' },
        { front: 'fó jiào', back: 'Buddhism', audio: '佛教' },
        { front: 'jiào', back: 'teach', audio: '教' },
        { front: 'jiàoshī', back: 'teacher', audio: '教师' },
        { front: 'fójīng', back: 'Buddhism scriptures', audio: '佛经' },
        { front: 'niànfó', back: 'chant the name of Buddha', audio: '念佛' },
        { front: 'niàn', back: 'to read multiple times to memorise', audio: '念' },
        { front: 'fó', back: 'Buddha', audio: '佛' },
        { front: 'nóngfū', back: 'farmer', audio: '农夫' },
        { front: 'fútī', back: 'escalator', audio: '扶梯' },
        { front: 'lóutī', back: 'stairs', audio: '楼梯' },
        { front: 'fǔtóu', back: 'axe', audio: '斧头' },
        { front: 'fùqīn', back: 'father (formal)', audio: '父亲' },
        { front: 'yúfū', back: 'fisherman', audio: '渔夫' },
        { front: 'biānfú', back: 'bat', audio: '蝙蝠' },
        { front: 'fù qián', back: 'pay money', audio: '付钱' },
        { front: 'dā bāshì', back: 'take bus', audio: '搭巴士' },
        { front: 'dàodá', back: 'arrive', audio: '到达' },
        { front: 'dǎsǎo', back: 'clean', audio: '打扫' },
        { front: 'dà hǎn', back: 'shout loudly', audio: '大喊' },
        { front: 'huídá', back: 'reply', audio: '回答' },
        { front: 'Dē dē shēng', back: 'sound of running horse', audio: '得得声' },
        { front: 'dé jiǎng', back: 'win a prize', audio: '得奖' },
        { front: 'dé', back: 'get', audio: '得' },
        { front: 'jiǎng', back: 'trophy', audio: '奖' },
        { front: 'dàodé', back: 'moral', audio: '道德' },
        { front: 'shuǐdī', back: 'water droplets', audio: '水滴' },
        { front: 'dízi', back: 'flute', audio: '笛子' },
        { front: 'hǎidǐ', back: 'seabed', audio: '海底' },
        { front: 'dǐ', back: 'low', audio: '底' },
        { front: 'dìqiú', back: 'earth', audio: '地球' },
        { front: 'dírén', back: 'enemy', audio: '敌人' },
        { front: 'dá\'àn', back: 'answer', audio: '答案' },
        { front: 'dūshì', back: 'urban city', audio: '都市' },
        { front: 'dú', back: 'poison', audio: '毒' },
        { front: 'dǔchē', back: 'traffic jam', audio: '堵车' },
        { front: 'dùzǐ', back: 'abdomen', audio: '肚子' },
        { front: 'dùlún', back: 'ferry', audio: '渡轮' }
      ],
      extravocab: [
        { front: 'xuéxiào', back: 'school', audio: '学校' },
        { front: 'yóuyǒng', back: 'swimming', audio: '游泳' },
        { front: 'chànggē', back: 'singging', audio: '唱歌' },
        { front: 'chàng', back: 'to sing', audio: '唱' },
        { front: 'gē', back: 'song', audio: '歌' },
        { front: 'shūběn', back: 'book', audio: '书本' },
        { front: 'shǒujī', back: 'handphone', audio: '手机' },
        { front: 'shǒu', back: 'hand', audio: '手' },
        { front: 'jī', back: 'device/machine', audio: '机' },
        { front: 'qiānbǐ', back: 'pencil', audio: '铅笔' },
        { front: 'yīngyǔ', back: 'English', audio: '英语' },
        { front: 'fǔdǎo', back: 'guide', audio: '辅导' },
        { front: 'chúguì', back: 'cupboard', audio: '橱柜' },
        { front: 'shìpín', back: 'video', audio: '视频' },
        { front: 'shì', back: 'sight', audio: '视' },
        { front: 'kèběn', back: 'textbook', audio: '课本' },
        { front: 'tàiyáng', back: 'sun', audio: '太阳' },
        { front: 'báibǎn', back: 'whiteboard', audio: '白板' },
        { front: 'chēchuāng', back: 'car window', audio: '车窗' },
        { front: 'shǒuzhǐ', back: 'finger', audio: '手指' },
        { front: 'diànnǎo', back: 'computer', audio: '电脑' },
        { front: 'kēxué', back: 'science', audio: '科学' },
        { front: 'bǎobèi', back: 'baby/ a precious one', audio: '宝贝' },
        { front: 'máobǐ', back: 'brush pen', audio: '毛笔' },
        { front: 'hēibǎn', back: 'blackboard', audio: '黑板' },
        { front: 'kǎoshì', back: 'exam', audio: '考试' },
        { front: 'bào zhǐ', back: 'newspaper', audio: '报纸' },
        { front: 'bào', back: 'to report', audio: '报' },
        { front: 'zhǐ', back: 'paper', audio: '纸' },
        { front: 'gōng sī', back: 'company', audio: '公司' },
        { front: 'huǒ chē', back: 'train', audio: '火车' },
        { front: 'huǒ', back: 'fire', audio: '火' },
        { front: 'kuài lè', back: 'happy', audio: '快乐' },
        { front: 'kuài', back: 'fast', audio: '快' },
        { front: 'jiè shào', back: 'introduce', audio: '介绍' },
        { front: 'gǒu', back: 'dog', audio: '狗' },
        { front: 'shēn tǐ', back: 'body', audio: '身体' },
        { front: 'shí jiān', back: 'time', audio: '时间' },
        { front: 'shǒu biǎo', back: 'watch', audio: '手表' },
        { front: 'nǔlì', back: 'hardworking', audio: '努力' },
        { front: 'shǒuzhuó', back: 'bangle', audio: '手镯' },
        { front: 'shuǐpíng', back: 'water bottle', audio: '水瓶' },
        { front: 'chīkǔ', back: 'suffer', audio: '吃苦' },
        { front: 'kǔ', back: 'bitter', audio: '苦' },
        { front: 'zhuōzǐ', back: 'table', audio: '桌子' },
        { front: 'zhuānyè', back: 'profession/professional', audio: '专业' },
        { front: 'rìlì', back: 'calendar', audio: '日历' },
        { front: 'xuéxí', back: 'learn', audio: '学习' },
        { front: 'yìsi', back: 'meaning', audio: '意思' },
        { front: 'zhōng', back: 'clock', audio: '钟' },
        { front: 'shíwù', back: 'food', audio: '食物' },
        { front: 'mǐfàn', back: 'rice', audio: '米饭' },
        { front: 'shūcài', back: 'vegetables', audio: '蔬菜' },
        { front: 'yúròu', back: 'meat of fish', audio: '鱼肉' },
        { front: 'hǎixiān', back: 'seafood', audio: '海鲜' },
        { front: 'bīngqílín', back: 'ice cream', audio: '冰淇淋' },
        { front: 'gālí', back: 'curry', audio: '咖喱' },
        { front: 'jīdàn', back: 'chicken egg', audio: '鸡蛋' },
        { front: 'Xiā', back: 'prawn', audio: '虾' },
        { front: 'miàntiáo', back: 'noodles', audio: '面条' },
        { front: 'chǎofàn', back: 'fried rice', audio: '炒饭' },
        { front: 'qiǎokèlì', back: 'chocolate', audio: '巧克力' },
        { front: 'bǐnggān', back: 'biscuit', audio: '饼干' },
        { front: 'zhá jī', back: 'fried chicken', audio: '炸鸡' },
        { front: 'yǐnliào', back: 'beverage', audio: '饮料' },
        { front: 'niúnǎi', back: 'cow milk', audio: '牛奶' },
        { front: 'lǜchá', back: 'green tea', audio: '绿茶' },
        { front: 'shuǐ', back: 'water', audio: '水' },
        { front: 'guǒzhī', back: 'fruit juice', audio: '果汁' },
        { front: 'kāfēi', back: 'coffee', audio: '咖啡' },
        { front: 'pí jiǔ', back: 'beer', audio: '啤酒' },
        { front: 'jiǔ', back: 'alcohol', audio: '酒' },
        { front: 'sū dǎ', back: 'soda', audio: '苏打' },
        { front: 'kě lè', back: 'cola', audio: '可乐' },
        { front: 'hóng chá', back: 'black tea', audio: '红茶' },
        { front: 'dìfāng', back: 'place', audio: '地方' },
        { front: 'kāfēi diàn', back: 'café', audio: '咖啡店' },
        { front: 'jiǔbā', back: 'bar', audio: '酒吧' },
        { front: 'chāojí shìchǎng', back: 'supermarket', audio: '超级市场' },
        { front: 'záhuò diàn', back: 'grocery shop', audio: '杂货店' },
        { front: 'fàndiàn', back: 'restaurant', audio: '饭店' },
        { front: 'gòuwù zhōng xīn', back: 'shopping mall', audio: '购物中心' },
        { front: 'hǎitān', back: 'beach', audio: '海滩' },
        { front: 'shìchǎng', back: 'market', audio: '市场' },
        { front: 'miànbāo fáng', back: 'bakery', audio: '面包房' },
        { front: 'rìjì', back: 'diary', audio: '日记' },
        { front: 'jì', back: 'to note down', audio: '记' },
        { front: 'lǎorén', back: 'old people', audio: '老人' },
        { front: 'xīnqíng', back: 'mood', audio: '心情' },
        { front: 'xīn', back: 'heart', audio: '心' },
        { front: 'qíngkuàng', back: 'situation', audio: '情况' },
        { front: 'tèbié', back: 'special', audio: '特别' },
        { front: 'xiàozhǎng', back: 'haedmaster', audio: '校长' },
        { front: 'xiàng jī', back: 'camera', audio: '相机' },
        { front: 'fùxí', back: 'revise', audio: '复习' },
        { front: 'dàxué', back: 'college/university', audio: '大学' },
        { front: 'zhōngxué', back: 'middle school/secondary school', audio: '中学' },
        { front: 'xiǎoxué', back: 'primary school', audio: '小学' },
        { front: 'xiǎo', back: 'small', audio: '小' },
        { front: 'shítáng', back: 'canteen', audio: '食堂' },
        { front: 'lǐtáng', back: 'hall', audio: '礼堂' },
        { front: 'huānyíng', back: 'welcome', audio: '欢迎' },
        { front: 'yǐzǐ', back: 'chair', audio: '椅子' },
        { front: 'wénjù', back: 'stationery', audio: '文具' },
        { front: 'tiàowǔ', back: 'dance', audio: '跳舞' },
        { front: 'tiào', back: 'to jump', audio: '跳' },
        { front: 'cǎochǎng', back: 'field', audio: '草场' },
        { front: 'cǎo', back: 'grass', audio: '草' },
        { front: 'shǒupà', back: 'handkerchief', audio: '手帕' },
        { front: 'làbǐ', back: 'crayon', audio: '蜡笔' },
        { front: 'rìqí', back: 'date', audio: '日期' },
        { front: 'húdié', back: 'butterfly', audio: '蝴蝶' },
        { front: 'cídiǎn', back: 'dictionary', audio: '词典' },
        { front: 'zuòyè', back: 'exercise book', audio: '作业' },
        { front: 'yánsè', back: 'color', audio: '颜色' },
        { front: 'hóngsè', back: 'red color', audio: '红色' },
        { front: 'chéngsè', back: 'orange color', audio: '橙色' },
        { front: 'chéng', back: 'orange (fruit)', audio: '橙' },
        { front: 'huángsè', back: 'yellow color', audio: '黄色' },
        { front: 'qīngsè', back: 'green color', audio: '青色' },
        { front: 'lán sè', back: 'blue color', audio: '蓝色' },
        { front: 'diànsè', back: 'indigo color', audio: '靛色' },
        { front: 'zǐsè', back: 'purple color', audio: '紫色' },
        { front: 'lǜsè', back: 'dark green color', audio: '绿色' },
        { front: 'hēisè', back: 'black color', audio: '黑色' },
        { front: 'báisè', back: 'white color', audio: '白色' },
        { front: 'hésè', back: 'brown color', audio: '褐色' },
        { front: 'hé', back: 'box', audio: '盒' },
        { front: 'huīsè', back: 'grey color', audio: '灰色' },
        { front: 'fěnhóng sè', back: 'pink color', audio: '粉红色' },
        { front: 'zuǒ', back: 'left', audio: '左' },
        { front: 'zuǒbiān', back: 'leftside', audio: '左边' },
        { front: 'qiánmiàn', back: 'front', audio: '前面' },
        { front: 'yòu', back: 'right', audio: '右' },
        { front: 'yòubiān', back: 'rightside', audio: '右边' },
        { front: 'hòumiàn', back: 'behind', audio: '后面' },
        { front: 'lǐmiàn', back: 'in', audio: '里面' },
        { front: 'zhuōzi', back: 'table', audio: '桌子' }
      ]
    },
    level2: {
      text: [
