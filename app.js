...
const FlashcardData = {
  mandarin: {
    newbie: [
      { front: 'language', back: 'yǔ', audio: '语' },
      { front: 'go to class', back: 'shàngkè', audio: '上课' },
      { front: 'finish class', back: 'xiàkè', audio: '下课' },
      { front: 'class', back: 'kè', audio: '课' },
      { front: 'very', back: 'hěn', audio: '很' },
      { front: 'happy', back: 'gāoxìng', audio: '高兴' },
      { front: 'to know', back: 'rènshi', audio: '认识' },
      { front: 'hello', back: 'nǐ hǎo', audio: '你好' },
      { front: 'you', back: 'nǐ', audio: '你' },
      { front: 'good', back: 'hǎo', audio: '好' },
      { front: 'hello everyone', back: 'dàjiā hǎo', audio: '大家好' },
      { front: 'everyone', back: 'dàjiā', audio: '大家' },
      { front: 'big', back: 'dà', audio: '大' },
      { front: 'home/house/family', back: 'jiā', audio: '家' },
      { front: 'I', back: 'wǒ', audio: '我' },
      { front: 'call/asked to', back: 'jiào', audio: '叫' },
      { front: 'also/too', back: 'yě', audio: '也' },
      { front: 'Mandarin', back: 'pǔtōnghuà', audio: '普通话' },
      { front: 'common', back: 'pǔtōng', audio: '普通' },
      { front: 'spoken words', back: 'huà', audio: '话' },
      { front: 'phonics', back: 'pīnyīn', audio: '拼音' },
      { front: 'China related', back: 'huá', audio: '华' },
      { front: 'four', back: 'sì', audio: '四' },
      { front: 'sound', back: 'shēng', audio: '声' },
      { front: 'grammar', back: 'yǔfǎ', audio: '语法' },
      { front: 'have/had/do/does/did/got', back: 'yǒu', audio: '有' },
      { front: 'question', back: 'wèntí', audio: '问题' },
      { front: 'to ask', back: 'wèn', audio: '问' },
      { front: 'don\'t have/didn\'t/haven\'t/hasn\'t', back: 'méiyǒu', audio: '没有' },
      { front: 'opposite direction/opposite party/opponent', back: 'duìfāng', audio: '对方' },
      { front: 'question particle for "yes-no" questions', back: 'ma', audio: '吗' },
      { front: 'question particle for subjects already mentioned (what about)', back: 'ne', audio: '呢' },
      { front: 'where', back: 'nǎlǐ', audio: '哪里' },
      { front: 'live/stay', back: 'zhù', audio: '住' },
      { front: 'at/in', back: 'zài', audio: '在' },
      { front: 'work', back: 'gōngzuò', audio: '工作' },
      { front: 'plural marker for noun/pronoun', back: 'men', audio: '们' },
      { front: 'understand', back: 'míngbái', audio: '明白' },
