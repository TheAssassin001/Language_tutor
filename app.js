  ...
  mandarin: {
    newbie: {
      novice: [
        ...
        { front: 'jiào', back: 'call / be called', audio: '' },
        ...
        { front: 'yǒu', back: 'have', audio: '' },
        { front: 'wèntí', back: 'question', audio: '' },
        { front: 'wèn', back: 'to ask', audio: '' },
        { front: 'méiyǒu', back: 'don’t have', audio: '' },
        { front: 'ma', back: 'yes-no question particle', audio: '' },
        { front: 'ne', back: 'question particle (“what about…”)', audio: '' },
        { front: 'nǎlǐ', back: 'where', audio: '' },
        { front: 'zhù', back: 'live / stay', audio: '' },
        { front: 'zài', back: 'at / in', audio: '' },
        { front: 'gōngzuò', back: 'work', audio: '' },
        { front: 'men', back: 'plural marker', audio: '' }
      ],
      rookie: [
        { front: 'míngbái', back: 'understand', audio: '' },
        { front: 'yīdiǎn', back: 'a little', audio: '' },
    ...
    level1: {
      text: {
        novice: [
          ...
          { front: 'jǐ', back: 'how many', audio: '' },
          { front: 'suì', back: 'age', audio: '' },
          { front: 'péngyǒu', back: 'friend', audio: '' },
          { front: 'shì', back: 'is / are / am', audio: '' },
        ...
        adept: [
          ...
          { front: 'shāngdiàn', back: 'shop', audio: '' },
          { front: 'shuǐguǒ', back: 'fruit', audio: '' },
